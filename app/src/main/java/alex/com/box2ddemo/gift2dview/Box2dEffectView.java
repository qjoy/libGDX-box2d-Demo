...
import alex.com.box2ddemo.gift2dview.Beans.BallInfo;
import alex.com.box2ddemo.gift2dview.Beans.Box2dConstant;
import alex.com.box2ddemo.gift2dview.Tools.Transform;
...
public class Box2dEffectView implements ApplicationListener {
    ...
    public void create() {
        ...
        TESTTEXTURE = new Texture(Gdx.files.internal("star.png"));
